...
class cCapturePlay:
    ...
    def open(self, iCaptureChannels, iSamplerate, iFramesize):
        ...
        #
        if self.iPlayData.size == 0 and self.bPlayback == True:
    ...
    def writeCaptureData(self, data):
        ...
        #self.captureFileHandle.write(data/32768)
...
sOriginalFolder = r'C:\Users\Administrator\Desktop\ASR_Team\xatx_1050_stereo'
sFinishedFolder = r'C:\Users\Administrator\Desktop\ASR_Team\xatx_1050_stereo_Finished'
sDesireFolder = r'C:\Users\Administrator\Desktop\ASR_Team\xatx_1050_stereo_2m_180D'
...
# iCaptureChannels = 2
fCaptureLeadSeconds = 0.0
fCaptureTrailSeconds = 0.0
...
for root, dirs, files in os.walk(sOriginalFolder):
    for SrcFilenames in files:
        ...
        sFinishedFilename = sSrcFilenames.replace(sOriginalFolder, sFinishedFolder)

        if not os.path.exists(os.path.dirname(sDstFilenames)):
            os.makedirs(os.path.dirname(sDstFilenames))

        if not os.path.exists(os.path.dirname(sFinishedFilename)):
            os.makedirs(os.path.dirname(sFinishedFilename))
        print(sSrcFilenames.replace(sOriginalFolder, '') + ' recording...')
        ...
        os.rename(sSrcFilenames, sFinishedFilename)
...
# print ""
#
# print "Test 004: Capture 2 channels"
# try:
#     sCaptureFile = "capture004.wav"
#     fCaptureSeconds = 5.0
#     a00.setupCapture(fCaptureSeconds)
#     a00.go(iCaptureChannels, iSamplerate, iFramesize, sCaptureFile)
#     print "Test 004 --> OK"
# except:
#     print "Test 004 --> FAILED"
# print ""
#
