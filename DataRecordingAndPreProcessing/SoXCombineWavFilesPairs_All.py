import os
for k in range(2,6):
    sOriginalFolder = r'D:\SpeechOcean_HeadsetRec_XATX\xatx_WuWRecordings_744\xatx_WuTaiShan_WuWRecordings_744_Pairs\xatx_744_' + str(k) + r'm_180D300D'
    sDstFolder = r'D:\SpeechOcean_HeadsetRec_XATX\xatx_WuWRecordings_744\xatx_WuTaiShan_WuWRecordings_744_PairsCombined\xatx_744_' + str(k) + r'm_180D300D'
