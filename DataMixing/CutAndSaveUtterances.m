function CutAndSaveUtterances(sOriginalRecordingsDir, sProcessedAudioDir, sCuttedAudioDir, iLeadingSilence)
    ...
    for i = 1:3:iCountProcessed
        ...
        sCuttedAudioSubDir = [sCuttedAudioDir, sProcessedAudioName(1: iIdxSlash(end-2)-1), '\'];
