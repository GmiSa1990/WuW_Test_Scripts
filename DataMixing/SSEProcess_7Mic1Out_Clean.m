function SSEProcess_7Mic1Out_Clean(audio_location, result_location, sse_work_dir, SCDName)
    ...
    for i = 1:count
        ...
        process_sse_cmd = 'runsse.exe -l sse_411_release_x86.dll -p prg_7MicUCAC_1Out.v';
