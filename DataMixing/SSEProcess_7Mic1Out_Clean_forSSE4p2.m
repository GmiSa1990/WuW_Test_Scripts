function SSEProcess_7Mic1Out_Clean_forSSE4p2(audio_location, result_location, sse_work_dir, SCDName)
    ...
    for i = 1:count
        ...
        process_sse_cmd = 'runsse.exe -l sse_4.2.0_RC2.dll -p prg_7MicUCAC_1Out.v';
