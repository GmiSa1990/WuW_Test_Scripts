...
sWuWRecordingsFolder = 'C:\NuanceSSE\RD\7MicUCACArray_SSE4pxTesting_ASRTest\WuW_XATX_Recordings_LSilence\SH_RoomWuTaiShan\';
sInterferenceFolder = 'C:\NuanceSSE\RD\7MicUCACArray_SSE4pxTesting_ASRTest\Interference_Recordings_Rescaled_Part\';
...
sRockMusicInput_Criteria = 'C:\NuanceSSE\RD\7MicUCACArray_SSE4pxTesting_ASRTest\Interference_Rescaled_Criteria\Sax\';
...
for i = 2:iWuWDistanceMax
    ...
    if i == 2   %Rescale to 2m speech
        ...
        fScaleFactor_RM2WuW = fDesiredSNRLinear.*fAverageRMS_RM./fAverageRMS; %To scale up WuW instead of Interference
